...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.lastMove'
        db.add_column(u'battles_player', 'lastMove',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='lastMove', null=True, to=orm['battles.Move']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.lastMove'
        db.delete_column(u'battles_player', 'lastMove_id')

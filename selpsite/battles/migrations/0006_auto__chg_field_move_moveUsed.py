...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Move.moveUsed'
        db.alter_column(u'battles_move', 'moveUsed', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Move.moveUsed'
        db.alter_column(u'battles_move', 'moveUsed', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'battles.move': {
            ...
            'moveUsed': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
        ...
        u'battles.player': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastMove': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'lastMove'", 'null': 'True', 'to': u"orm['battles.Move']"}),
